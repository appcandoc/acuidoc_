...
<ac-view class="demo-content">
  <ac-picker title="" range="{{ list }}" value="{{ val }}" bindchange="handleChange"></ac-picker>
  <ac-button bindtap="getStorage">获取缓存</ac-button>
</ac-view>
...
<ac-view class="demo-content">
  ...
  <ac-row >
    ...
    <ac-col span="6" space-left="5">
        <ac-button bindtap="clearStorage">清理本地数据缓存</ac-button>
    </ac-col>
  </ac-row>
</ac-view>
```

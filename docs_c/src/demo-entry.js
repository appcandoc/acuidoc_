...
export default {
  ...
  'audio': () => wrapper(import('../../packages/audio/demo'), 'audio'),
  'badge': () => wrapper(import('../../packages/badge/demo'), 'badge'),
  'canvas': () => wrapper(import('../../packages/canvas/demo'), 'canvas'),
  ...
  'form': () => wrapper(import('../../packages/form/demo'), 'form'),
  ...
  'input': () => wrapper(import('../../packages/input/demo'), 'input'),
  'label': () => wrapper(import('../../packages/label/demo'), 'label'),
  ...
  'navigator': () => wrapper(import('../../packages/navigator/demo'), 'navigator'),
  ...
  'propress': () => wrapper(import('../../packages/propress/demo'), 'propress'),
  ...
  'scrollview': () => wrapper(import('../../packages/scrollview/demo'), 'scrollview'),
  ...
  'swiper': () => wrapper(import('../../packages/swiper/demo'), 'swiper'),
  ...
  'text': () => wrapper(import('../../packages/text/demo'), 'text'),
  'textarea': () => wrapper(import('../../packages/textarea/demo'), 'textarea'),
  ...
  'video': () => wrapper(import('../../packages/video/demo'), 'video'),
  'view': () => wrapper(import('../../packages/view/demo'), 'view'),
